 ...
 * Basic Email Example
 * 
 * This example demonstrates how to send a simple email using the SendPost PHP SDK.
 * 
 * Prerequisites:
 * - Set SENDPOST_SUB_ACCOUNT_API_KEY environment variable
 * - Or update SUB_ACCOUNT_API_KEY constant below
 * 
 * Run: php src/BasicEmailExample.php
 */
...
try {
    ...
    $emailMessage->setHtmlBody('<h1>Welcome!</h1><p>This is a test email sent using the SendPost PHP SDK.</p>');
    $emailMessage->setTextBody('Welcome! This is a test email sent using the SendPost PHP SDK.');
